...
declare type CloneButtonProps = Props$e & ButtonProps;
...
interface Props$c<RecordType extends RaRecord = any> {
    icon?: ReactElement;
    label?: string;
    record?: RecordType;
    resource?: string;
...
declare type ShowButtonProps<RecordType extends RaRecord = any> = Props$c<RecordType> & ButtonProps;
...
interface EditProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
...
interface CreateProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    actions?: ReactElement | false;
    aside?: ReactElement;
    className?: string;
    component?: ElementType;
...
interface DeleteButtonProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> extends ButtonProps, SaveContextValue {
    confirmTitle?: string;
...
interface DeleteWithConfirmButtonProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> extends ButtonProps {
    confirmTitle?: string;
...
interface DeleteWithUndoButtonProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> extends ButtonProps {
    icon?: ReactElement;
    onClick?: ReactEventHandler<any>;
    mutationOptions?: UseMutationOptions<RecordType, MutationOptionsError, DeleteParams<RecordType>>;
    record?: RecordType;
...
interface Props$8<RecordType extends RaRecord = any> {
    icon?: ReactElement;
    label?: string;
    record?: RecordType;
    resource?: string;
...
declare type EditButtonProps<RecordType extends RaRecord = any> = Props$8<RecordType> & ButtonProps;
...
interface Props$3<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    className?: string;
    disabled?: boolean;
    icon?: ReactElement;
    invalid?: boolean;
...
interface TabbedFormProps extends Omit<FormProps, 'render'>, Omit<HtmlHTMLAttributes<HTMLFormElement>, 'defaultValue' | 'onSubmit' | 'children'>, Partial<TabbedFormViewProps> {
    children: ReactNode;
    className?: string;
    defaultValues?: any;
    formRootPathname?: string;
...
interface ToolbarProps extends Omit<ToolbarProps$1, 'classes'> {
    children?: ReactNode;
    className?: string;
    resource?: string;
}
...
interface NumberInputProps extends CommonInputProps, Omit<TextFieldProps$2, 'label' | 'helperText' | 'defaultValue' | 'onChange' | 'onBlur' | 'type'> {
    step?: string | number;
    min?: string | number;
    max?: string | number;
}
...
declare const SingleFieldList: {
    ...
    propTypes: {
        ...
        resource: PropTypes__default.Requireable<string>;
        sx: PropTypes__default.Requireable<object>;
    };
};
